...
from tkai.v9.governance_mesh.registry import GovernanceRegistryCatalog
from tkai.v9.governance_mesh.relationships import (
    GovernanceRelationship,
    RelationshipGraph,
)
from tkai.v9.governance_mesh.security import secure_metadata
...
class AdaptiveGovernanceMesh:
    """Advisory governance federation spanning every V6 through V9 surface."""

    ID = "tkai-v9-adaptive-governance-mesh"
    VERSION = "9.0.0"
    MODE = "reference-only"
    ...
    def aggregate_metadata(
        ...
        *,
        ...
        self._sources = self.policy_fabric.aggregate(
            v6_governance_centers=v6_governance_centers,
