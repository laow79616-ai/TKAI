"""Immutable contracts for the metadata-only Adaptive Knowledge Mesh."""
...
class KnowledgeLifecycle(str, Enum):
    """Lifecycle of knowledge metadata, never of runtime execution."""
...
class FederationProfile:
    """Complete cross-version knowledge metadata profile."""
    ...
    tenant_reference: KnowledgeReference | None = None
    workspace_reference: KnowledgeReference | None = None
    domain_references: tuple[KnowledgeReference, ...] = ()
    ontology_references: tuple[KnowledgeReference, ...] = ()
    taxonomy_references: tuple[KnowledgeReference, ...] = ()
    framework_references: tuple[KnowledgeReference, ...] = ()
    ai_center_references: tuple[KnowledgeReference, ...] = ()
    knowledge_references: tuple[KnowledgeReference, ...] = ()
    evidence_references: tuple[KnowledgeReference, ...] = ()
    signal_references: tuple[KnowledgeReference, ...] = ()
    ...
    lineage_references: tuple[KnowledgeReference, ...] = ()
    health: str = "unknown"
...
class ReasoningSummary:
    ...
    evaluation_references: tuple[KnowledgeReference, ...] = ()
    explanation_references: tuple[KnowledgeReference, ...] = ()
    confidence_references: tuple[KnowledgeReference, ...] = ()
    metadata: Mapping[str, object] = field(default_factory=immutable_metadata)
    scope: KnowledgeScope = KnowledgeScope()
...
class Recommendation:
    ...
    summary: str
    evidence_references: tuple[KnowledgeReference, ...] = ()
    reasoning_reference: KnowledgeReference | None = None
    confidence: float | None = None
    metadata: Mapping[str, object] = field(default_factory=immutable_metadata)
    scope: KnowledgeScope = KnowledgeScope()
...
KnowledgeMeshProfile = FederationProfile
