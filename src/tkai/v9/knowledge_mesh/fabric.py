"""Adaptive Knowledge Mesh composition root."""
...
from tkai.v9.knowledge_mesh.registry import KnowledgeMeshRegistryCatalog
from tkai.v9.knowledge_mesh.relationships import Relationship, RelationshipGraph
from tkai.v9.knowledge_mesh.security import secure_metadata
...
class AdaptiveKnowledgeMesh:
    ...
    def aggregate_metadata(
        ...
        *,
        ...
        v9_components: tuple[KnowledgeReference | Mapping[str, object], ...] = (),
        actor: str = "system",
    ...
    def add_relationship(
        ...
        self.observability.increment("knowledge.relationships.registered")
        self.observability.audit(
            "knowledge.relationship.registered",
            actor,
...
KnowledgeMeshFabric = AdaptiveKnowledgeMesh

__all__ = ("AdaptiveKnowledgeMesh", "KnowledgeMeshFabric", "serialize_record")
