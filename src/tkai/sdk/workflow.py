"""Declarative workflow definitions; V1.x runtime retains execution ownership."""
...
class NodeKind(str, Enum):
    """Portable workflow node categories for SDK declarations."""
...
class WorkflowDefinition:
    """Immutable, execution-agnostic workflow graph for future adapters."""
...
class WorkflowBuilder:
    """Build validated declarations without executing workflow business logic."""
    ...
    def build(self, *, entrypoint: str | None = None) -> WorkflowDefinition:
        """Return an immutable definition after shallow graph-name validation."""
