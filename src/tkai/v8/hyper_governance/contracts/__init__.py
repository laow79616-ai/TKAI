"""Immutable contracts for the advisory V8 Hyper Governance Fabric."""
...
class GovernanceReference:
    ...
    def __post_init__(self) -> None:
        ...
        if self.generation.lower() not in {"", "v6", "v7", "v8"}:
...
class CompatibilityRecord:
    """Cross-version V6/V7/V8 governance compatibility metadata."""
