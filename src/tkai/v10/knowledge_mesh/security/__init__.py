"""RBAC, isolation, and secret-filtering guards for knowledge metadata."""
...
def authorize_metadata_read(
    ...
    *,
    ...
    if not {"reader", "auditor", "knowledge-metadata-reader"}.intersection(
        role_references
    ):
        raise PermissionError("RBAC knowledge metadata read denied")
