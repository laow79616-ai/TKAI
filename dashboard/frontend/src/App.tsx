...
import {
  ...
  TikTokBusinessWorkspacePage, TikTokLeadManagementPage, TikTokCRMCenterPage, TikTokCustomerJourneyCenterPage, TikTokGrowthCenterPage, TikTokPerformanceInsightsPage, LicensesPage, LoginPage, MarketplacePage, NotFoundPage, PackagesPage,
...
export function App() {
  return <Routes><Route path="/login" element={<LoginPage />} /><Route element={<Shell />}>
    ...
    <Route path="/tiktok-crm-center" element={<TikTokCRMCenterPage />} />
    <Route path="/tiktok-customer-journey-center" element={<TikTokCustomerJourneyCenterPage />} />
