...
import { AgentDefinitionsPage, AgentRunDetailsPage, AgentRunsPage, dashboardPages, DashboardHome, EnterprisePage, HealthPage, LoginPage, NotFoundPage, PackagesPage, PublishersPage, RegistryPage, SearchPage, StatisticsPage, VersionsPage } from "./pages";
...
export function App() { return <Routes><Route path="/login" element={<LoginPage />} /><Route element={<Shell />}><Route path="/dashboard" element={<DashboardHome />} /><Route path="/agents" element={<AgentDefinitionsPage />} /><Route path="/agent-runs" element={<AgentRunsPage />} /><Route path="/agent-runs/:id" element={<AgentRunDetailsPage />} /><Route path="/registry" element={<RegistryPage />} /><Route path="/publishers" element={<PublishersPage />} /><Route path="/packages" element={<PackagesPage />} /><Route path="/versions" element={<VersionsPage />} /><Route path="/search" element={<SearchPage />} /><Route path="/statistics" element={<StatisticsPage />} /><Route path="/health" element={<HealthPage />} /><EnterpriseRoutes /></Route><Route path="/" element={<Navigate to="/dashboard" replace />} /><Route path="*" element={<NotFoundPage />} /></Routes>; }
