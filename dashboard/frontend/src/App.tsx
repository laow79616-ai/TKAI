...
import {
  ...
  dashboardPages, businessPlatformDashboardPages, hyperKernelDashboardPages, hyperCoordinationDashboardPages, hyperIntelligenceDashboardPages, capabilityDashboardPages, extensionDashboardPages, workflowDashboardPages, memoryDashboardPages, reasoningDashboardPages, collaborationDashboardPages, governanceDashboardPages, modelDashboardPages, securityDashboardPages, apiManagementDashboardPages, integrationHubDashboardPages, digitalTwinDashboardPages, businessIntelligenceDashboardPages, commandCenterDashboardPages, knowledgeGraphDashboardPages, tiktokDashboardPages, DashboardHome, V11DashboardPage, DownloadsPage, EnterprisePage, HealthPage, TikTokInteractionCenterPage, TikTokRiskControlCenterPage, TikTokOperationsCenterPage, TikTokResourceCenterPage, TikTokAutomationEnginePage, TikTokExecutionEnginePage, TikTokAIControlTowerPage, TikTokAIIntelligentDecisionCenterPage, TikTokLocalRuntimePage, HyperKernelPage, HyperCoordinationPage, HyperIntelligencePage,
  BusinessPlatformPage, TikTokAutonomousOperationPage, TikTokAutonomousMissionEnginePage, TikTokAutonomousIntelligenceCenterPage, TikTokBusinessWorkspacePage, TikTokLeadManagementPage, TikTokBusinessIntelligencePage, TikTokGrowthCenterPage, TikTokPerformanceInsightsPage, LicensesPage, LoginPage, MarketplacePage, NotFoundPage, PackagesPage,
...
function Shell() {
  ...
  return <div className="dashboard-shell"><Sidebar pages={[...businessPlatformDashboardPages, ...dashboardPages, ...hyperKernelDashboardPages, ...hyperCoordinationDashboardPages, ...hyperIntelligenceDashboardPages, ...capabilityDashboardPages, ...extensionDashboardPages, ...workflowDashboardPages, ...memoryDashboardPages, ...reasoningDashboardPages, ...collaborationDashboardPages, ...governanceDashboardPages, ...modelDashboardPages, ...securityDashboardPages, ...apiManagementDashboardPages, ...integrationHubDashboardPages, ...digitalTwinDashboardPages, ...businessIntelligenceDashboardPages, ...commandCenterDashboardPages, ...knowledgeGraphDashboardPages, ...tiktokDashboardPages]} /><main><Header onLogout={() => { logout().finally(() => navigate("/login")); }} /><ErrorBoundary><Outlet /></ErrorBoundary></main></div>;
}

export function App() {
  return <Routes><Route path="/login" element={<LoginPage />} /><Route element={<Shell />}>
    <Route path="/dashboard" element={<DashboardHome />} />
    {businessPlatformDashboardPages.map((page) => <Route key={page} path={`/${page}`} element={<BusinessPlatformPage resource={page === "business-home" ? "dashboard" : page.replace("business-", "")} />} />)}
    {["overview", "health", "diagnostics", "knowledge", "reasoning", "decision", "planning", "operations", "recovery", "governance", "trust", "integrity", "compatibility", "validation", "metrics", "audit"].map((section) => <Route key={section} path={`/v11-${section}`} element={<V11DashboardPage section={section} />} />)}
    ...
    <Route path="/v8-coordination" element={<HyperCoordinationPage />} />
    <Route path="/v8-coordination-frameworks" element={<HyperCoordinationPage title="Framework Registry" resource="frameworks" />} />
    <Route path="/v8-coordination-dependencies" element={<HyperCoordinationPage title="Dependencies" resource="dependencies" />} />
    <Route path="/v8-coordination-relationships" element={<HyperCoordinationPage title="Relationships" resource="relationships" />} />
    <Route path="/v8-coordination-synchronization" element={<HyperCoordinationPage title="Synchronization" resource="synchronization" />} />
    <Route path="/v8-coordination-compatibility" element={<HyperCoordinationPage title="Compatibility" resource="compatibility" />} />
    <Route path="/v8-coordination-governance" element={<HyperCoordinationPage title="Governance" resource="governance" />} />
    <Route path="/v8-coordination-health" element={<HyperCoordinationPage title="Health" resource="health" />} />
    <Route path="/v8-coordination-metrics" element={<HyperCoordinationPage title="Metrics" resource="metrics" />} />
    <Route path="/v8-coordination-audit" element={<HyperCoordinationPage title="Audit" resource="audit" />} />
    <Route path="/v8-intelligence" element={<HyperIntelligencePage />} />
    <Route path="/v8-intelligence-knowledge" element={<HyperIntelligencePage title="Knowledge" resource="knowledge" />} />
    <Route path="/v8-intelligence-evidence" element={<HyperIntelligencePage title="Evidence" resource="evidence" />} />
    <Route path="/v8-intelligence-signals" element={<HyperIntelligencePage title="Signals" resource="signals" />} />
    <Route path="/v8-intelligence-recommendations" element={<HyperIntelligencePage title="Recommendations" resource="recommendations" />} />
    <Route path="/v8-intelligence-compatibility" element={<HyperIntelligencePage title="Compatibility" resource="compatibility" />} />
    <Route path="/v8-intelligence-health" element={<HyperIntelligencePage title="Health" resource="health" />} />
    <Route path="/v8-intelligence-metrics" element={<HyperIntelligencePage title="Metrics" resource="metrics" />} />
    <Route path="/v8-intelligence-audit" element={<HyperIntelligencePage title="Audit" resource="audit" />} />
    ...
    <Route path="/capabilities-health" element={<CapabilityFrameworkPage title="Capability Health" resource="health" />} />
    <Route path="/capabilities-metrics" element={<CapabilityFrameworkPage title="Capability Metrics" resource="metrics" />} />
    ...
    <Route path="/tiktok-business-workspace" element={<TikTokBusinessWorkspacePage />} />
    <Route path="/tiktok-lead-management" element={<TikTokLeadManagementPage />} />
    <Route path="/tiktok-business-intelligence" element={<TikTokBusinessIntelligencePage />} />
    ...
    <Route path="/tiktok-autonomous-mission-engine" element={<TikTokAutonomousMissionEnginePage />} />
    <Route path="/tiktok-autonomous-intelligence-center" element={<TikTokAutonomousIntelligenceCenterPage />} />
