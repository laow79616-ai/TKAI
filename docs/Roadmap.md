...
- Marketplace and remote-plugin distribution, security review, and lifecycle
  management.
- Production Studio collaboration, WebSocket monitoring, and Agent Chat
  transport.

This roadmap is directional only; it does not promise implementation dates or
change Platform 1.0 support commitments.
