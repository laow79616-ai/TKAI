"""Mock-only tests for the V8 Hyper Governance Fabric."""
...
from tkai.v8.hyper_governance.analytics import coverage_summary
from tkai.v8.hyper_governance.api import (
    GET_ROUTES,
    openapi_contract,
    register_routes,
)
from tkai.v8.hyper_governance.approvals import authorizes_execution
from tkai.v8.hyper_governance.boundaries import BOUNDARY_TYPES
from tkai.v8.hyper_governance.compliance import enforces_compliance
...
from tkai.v8.hyper_governance.dashboard import (
    DASHBOARD_SECTIONS,
    dashboard_snapshot,
)
...
from tkai.v8.hyper_governance.relationships import GovernanceRelationship
from tkai.v8.hyper_governance.security import (
...
def test_policy_fabric_aggregates_all_generations_by_reference_only() -> None:
    ...
    result = fabric.aggregate(
        v6_governance=({"identifier": "v6-governance"},),
