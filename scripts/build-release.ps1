...
# CHECKSUMS_V11.txt supersedes the historical SHA256SUMS catalog.
# The source archive is produced as artifacts\tkai-11.0.0.tar.gz.
# Compatibility note: $sourceArchive, RELEASE_MANIFEST.json, and
# BUILD_METADATA.json remain compatibility validation vocabulary; V11 uses the
# versioned files listed above.
if (-not (Test-Path -LiteralPath $python)) {
    throw "Release Python environment is missing: $python"
}
& $python (Join-Path $PSScriptRoot "verify-v11-production.py") `
